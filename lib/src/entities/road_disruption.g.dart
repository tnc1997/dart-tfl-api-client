...
RoadDisruption _$RoadDisruptionFromJson(Map<String, dynamic> json) {
  return RoadDisruption(
      ...
      corridorIds:
          (json['corridorIds'] as List)?.map((e) => e as String)?.toList(),
      ...
      geography: json['geography'] == null
          ? null
          : DbGeography.fromJson(json['geography'] as Map<String, dynamic>),
      geometry: json['geometry'] == null
          ? null
          : DbGeography.fromJson(json['geometry'] as Map<String, dynamic>),
      streets: (json['streets'] as List)
          ?.map((e) =>
              e == null ? null : Street.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      ...
      roadDisruptionLines: (json['roadDisruptionLines'] as List)
          ?.map((e) => e == null
              ? null
              : RoadDisruptionLine.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      roadDisruptionImpactAreas: (json['roadDisruptionImpactAreas'] as List)
          ?.map((e) => e == null
              ? null
              : RoadDisruptionImpactArea.fromJson(e as Map<String, dynamic>))
          ?.toList(),
      recurringSchedules: (json['recurringSchedules'] as List)
          ?.map((e) => e == null
              ? null
              : RoadDisruptionSchedule.fromJson(e as Map<String, dynamic>))
          ?.toList());
}
