...
class JourneysApi {
  ...
  JourneysApi(this._requester);

  /// Gets the journey itinerary result from a [from] to a [to].
  ///
  /// \[HttpGet\]
  Future<ItineraryResult> get(
    String from,
    String to, {
    String via,
    bool nationalSearch,
    ...
    if (from == null || from.isEmpty) throw ArgumentError.notNull('from');
    if (to == null || to.isEmpty) throw ArgumentError.notNull('to');
    ...
    return ItineraryResult.fromJson(response);
  }
}
