...
class RecommendationResponse {
  ...
  static List<RecommendationResponse> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RecommendationResponse>()
        : json
            .map((value) => new RecommendationResponse.fromJson(value))
            .toList();
  }

  static Map<String, RecommendationResponse> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RecommendationResponse>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RecommendationResponse.fromJson(value));
    }
    return map;
  }
}
