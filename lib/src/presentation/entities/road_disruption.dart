...
/// The associated road project.
  ...
  static List<RoadDisruption> listFromJson(List<dynamic> json) {
    return json == null
        ? new List<RoadDisruption>()
        : json.map((value) => new RoadDisruption.fromJson(value)).toList();
  }

  static Map<String, RoadDisruption> mapFromJson(
      Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RoadDisruption>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) =>
          map[key] = new RoadDisruption.fromJson(value));
    }
    return map;
  }
}
